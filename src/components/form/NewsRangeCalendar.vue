  ...
  >
    <template #default="{ togglePopover, inputValue, inputEvents }">
      <div class="flex items-center gap-2 lg:gap-3">
        <div class="flex items-center justify-between gap-2 px-2 py-2 pl-3 bg-white shadow-xl lg:shadow-none rounded-3xl lg:rounded-none lg:gap-4 lg:px-5 lg:py-2">
